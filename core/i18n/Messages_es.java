...
public class Messages_es extends com.greenyetilab.linguaj.Messages {
    public Messages_es() {
        ...
        plainEntries.put("High score: %d", "Máx Puntuación: %d");
        ...
        plainEntries.put("New High Score!", "¡Nueva máx puntuación!");
        plainEntries.put("New item unlocked!", "¡Nuevo elemento desbloqueado!");
        plainEntries.put("No high score yet", "Todavía no hay máxima puntuación");
